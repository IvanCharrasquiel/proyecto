...
namespace ApiProyecto.Controllers
{
    ...
    public class MetodoPagoesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<MetodoPago>>> GetOMetodoPago()
        {
            return await _context.OMetodoPago.ToListAsync();
        }
        ...
        {
            var metodoPago = await _context.OMetodoPago.FindAsync(id);
        ...
        {
            _context.OMetodoPago.Add(metodoPago);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteMetodoPago(int id)
        {
            ...
            _context.OMetodoPago.Remove(metodoPago);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.OMetodoPago.Any(e => e.IdMetodoPago == id);
        }
    }
}
